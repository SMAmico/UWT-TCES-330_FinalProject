...
create_clock -name {Processor_Clk} -period 20.000 -waveform { 0.000 10.000 } [get_nets {keyfilter0|Out}]
...
set_clock_uncertainty -rise_from [get_clocks {Processor_Clk}] -rise_to [get_clocks {Processor_Clk}]  0.270  
set_clock_uncertainty -rise_from [get_clocks {Processor_Clk}] -fall_to [get_clocks {Processor_Clk}]  0.270  
set_clock_uncertainty -fall_from [get_clocks {Processor_Clk}] -rise_to [get_clocks {Processor_Clk}]  0.270  
set_clock_uncertainty -fall_from [get_clocks {Processor_Clk}] -fall_to [get_clocks {Processor_Clk}]  0.270  
