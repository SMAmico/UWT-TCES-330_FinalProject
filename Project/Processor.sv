...
module Processor(
    ...
    */
    ...
    /*
    The PC is stored in register 16 (address 4'hF) inside the datapath register file.
    */
    ...
    */
    ...
    // PC control wires generated by FSM in Control_Unit and consumed by datapath register 16.
    wire PC_clr;
    wire PC_up;
    wire PC_w_en;
    wire [15:0] PC_set;
    wire [15:0] PC_Out_Internal;  // internal PC output from datapath register 16
    assign PC_Out = PC_Out_Internal;  // connect internal PC output to external output
    /*
